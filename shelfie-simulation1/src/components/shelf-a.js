...
export default class A extends Component {
    ...
    render() {
        return (
            <div>
                <div className='main-header bin-header'>
                    <div className='header-content'>
                <Link to='/'><img src="https://github.com/DevMountain/simulation-1/blob/master/assets/logo.png?raw=true" alt="logo" className="header-logo logo'"/></Link>
